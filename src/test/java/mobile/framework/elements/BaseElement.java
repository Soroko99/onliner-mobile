...
import mobile.framework.Browser;
import mobile.framework.PropertyReader;
...
import static mobile.framework.PropertyReader.getProperty;
...
public abstract class BaseElement extends BaseTest {
    ...
    public void moveToElement() {
        ...
        log.info(getLoc("log.moveTo" + ":" + getElementType() + "=" + by));
    }
